<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="系统网格覆盖市区域名称" prop="cityName">
        <el-input
          v-model="queryParams.cityName"
          placeholder="请输入系统网格覆盖市区域名称"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="所属省区编号" prop="provinceId">
        <el-input
          v-model="queryParams.provinceId"
          placeholder="请输入所属省区编号"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="cityList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="系统网格覆盖市区域编号" align="center" prop="cityId" />
      <el-table-column label="系统网格覆盖市区域名称" align="center" prop="cityName" />
      <el-table-column label="所属省区编号" align="center" prop="provinceId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          <el-col :span="24">
            <el-form-item label="系统网格覆盖市区域名称" prop="cityName">
              <el-input v-model="form.cityName" placeholder="请输入系统网格覆盖市区域名称" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="所属省区编号" prop="provinceId">
              <el-input v-model="form.provinceId" placeholder="请输入所属省区编号" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="备注" prop="remarks">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        cityName: [
          { required: true, message: "系统网格覆盖市区域名称不能为空", trigger: "blur" }
        ],
        provinceId: [
          { required: true, message: "所属省区编号不能为空", trigger: "blur" }
        ],
      }
    }
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除系统网格覆盖市区域编号为"' + cityIds + '"的数据项？').then(function() {
