<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="常驻省编码" prop="provinceCode">
        <el-input
          v-model="queryParams.provinceCode"
          placeholder="请输入常驻省编码"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="常驻市编码" prop="cityCode">
        <el-input
          v-model="queryParams.cityCode"
          placeholder="请输入常驻市编码"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:inspector:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="inspectorList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="常驻省编码" align="center" prop="provinceCode" />
      <el-table-column label="常驻市编码" align="center" prop="cityCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="常驻省编码" prop="provinceCode">
              <el-input v-model="form.provinceCode" placeholder="请输入常驻省编码" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="常驻市编码" prop="cityCode">
              <el-input v-model="form.cityCode" placeholder="请输入常驻市编码" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
import { listInspector, getInspector, delInspector, addInspector, updateInspector } from "@/api/system/inspector"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除AQI检测网格员详细信息编号为"' + inspectorIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/inspector/export', {
        ...this.queryParams
